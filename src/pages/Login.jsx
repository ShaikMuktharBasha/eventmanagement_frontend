...
import { Mail, Lock, User as UserIcon, Calendar, ArrowRight, ShieldCheck, BadgeCheck, ShieldAlert, Eye, EyeOff, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function Login({ onNavigate }) {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center py-16 px-4 overflow-hidden transition-all duration-500 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.2),rgba(255,255,255,0))]">
      ...
      <div className="absolute top-1/2 left-1/2 -z-10 h-[30rem] w-[30rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-600/10 blur-3xl animate-pulse duration-[10s]" />
      <div className="absolute top-1/3 left-1/4 -z-10 h-[20rem] w-[20rem] rounded-full bg-indigo-500/10 blur-3xl animate-pulse duration-[6s]" />

      {/* Centered Login Card */}
      <div className="w-full max-w-md p-8 rounded-3xl glass-card border border-border/40 shadow-2xl space-y-6 animate-fade-in text-card-foreground self-center relative backdrop-blur-xl">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="space-y-1">
            <h2 className="text-2xl font-black tracking-tight text-foreground bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">
