...
function MainAppContent() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground transition-colors duration-300">
      {currentPage !== 'login' && <Navbar onNavigate={handleNavigation} currentPage={currentPage} />}
      
      {/* Main page wrapper */}
      <main className={`flex-1 w-full ${currentPage === 'login' ? 'p-0 flex items-center justify-center' : 'px-4 sm:px-8 lg:px-12 py-4'}`}>
        {renderPage()}
      </main>
